...
var DEFAULT_LOCALE = "en";
  ...
  var MESSAGES = {
    en: {
      "page.title": "ProGen UI Audit — Example Project Report",
      ...
      "audit.titlePrefix": "ProGen UI Audit",
      "audit.commitLabel": "Commit",
      "audit.generatedLabel": "Generated",
      "audit.ragBadge": "RAG: {rating}",
      "audit.goLiveBadge": "Go-live: {answer}",
      "audit.goLiveStatusLaunchReady": "Launch Ready",
      "audit.goLiveStatusControlledLaunch": "Controlled Launch",
      "audit.metaRepoUrl": "Repo",
      "audit.metaSiteUrl": "Site URL",
      "audit.metaProjectType": "Project type",
      "audit.metaProjectManager": "Project manager",
      "audit.metaArchitectLead": "Architect / lead",
      "audit.metaCurrentPhase": "Current phase",
      "audit.metaAuditDate": "Audit date",
      "audit.metaAuditVersion": "Audit version",
      "audit.metaAuditorName": "Auditor name",
      "pdf.download": "Report",
    ...
    es: {
      "page.title": "Auditoría UI ProGen — Informe de ejemplo",
      ...
      "audit.titlePrefix": "Auditoría UI ProGen",
      "audit.commitLabel": "Commit",
      "audit.generatedLabel": "Generado",
      "audit.ragBadge": "RAG: {rating}",
      "audit.goLiveBadge": "Puesta en vivo: {answer}",
      "audit.goLiveStatusLaunchReady": "Listo para el lanzamiento",
      "audit.goLiveStatusControlledLaunch": "Lanzamiento controlado",
      "audit.metaRepoUrl": "Repositorio",
      "audit.metaSiteUrl": "URL del sitio",
      "audit.metaProjectType": "Tipo de proyecto",
      "audit.metaProjectManager": "Gestor de proyecto",
      "audit.metaArchitectLead": "Arquitecto / líder técnico",
      "audit.metaCurrentPhase": "Fase actual",
      "audit.metaAuditDate": "Fecha de auditoría",
      "audit.metaAuditVersion": "Versión de auditoría",
      "audit.metaAuditorName": "Nombre del auditor",
      "pdf.download": "Informe",
